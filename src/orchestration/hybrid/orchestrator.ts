 ...
 * 
 * 从 lib/ziwei/hybrid/orchestrator.ts 迁移至 orchestration/hybrid/orchestrator.ts
 */

import 'server-only'

import type { ZiweiSessionData, ConversationTurn } from '@/lib/ziwei/session/types'
...
import { buildBaseIR } from '@/core/adapters/iztro'
import { buildFinalIRFromStages } from '@/core/adapters/iztro'
import { mergeCollected, parseHybridAssistantPayload } from '@/core/adapters/iztro/ai-parse'
import { evaluateJsonPatterns } from '@/core/adapters/iztro'
